    ...
    const fetchProjectTitle = async (tkn: string) => {
        ...
        try {
            ...
            if (data.friendRequest || data.type === 'friend') {
                ...
                // Update document title for friend requests
                document.title = "Accept Friend Request - coi";
            ...
            if (data.type === 'project') {
                document.title = `Join Project: ${data.title} - coi`;
...
export default function InviteContentWrapper() {
    return (
